				...
				<div class="col-lg-8 col-xl-6">
					<div class="card rounded-3">
						...
						<div class="card-body p-2 p-md-10">
							<h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Update Product Requirements</h3>

							<form action="update-product" method="post">
								<div data-mdb-input-init class="form-outline mb-4">
									<input type="number" id="form3Example1q" name="ID"
										placeholder="Enter Product ID" value="${p.ID}" class="form-control"
										required="required"  />
								</div>
								<div data-mdb-input-init class="form-outline mb-4">
									<input type="text" id="form3Example1q" name="name"
										placeholder="Enter Product Name" value="${p.name}" class="form-control"
										required="required" />
								</div>
								<div data-mdb-input-init class="form-outline mb-4">
									<input type="number" id="form3Example1q" name="price"
										placeholder="Enter Product Price" value="${p.price}" class="form-control"
										required="required" />
								</div>
								<div data-mdb-input-init class="form-outline mb-4">
									<input type="number" id="form3Example1q" name="quantity"
										placeholder="Enter Product Quantity" value="${p.quantity}" class="form-control"
										required="required" />
								</div>
								<div data-mdb-input-init class="form-outline mb-4">
									...
									<label class="form-label" for="form3Example1q">Product
										...
										<option value="${p.category}" disabled selected>Select Product
											Category</option>
						...
						<button type="submit" data-mdb-button-init data-mdb-ripple-init
							class="btn btn-success btn-lg mb-1">UPDATE</button>
						</form>
					</div>
				</div>
			</div>
